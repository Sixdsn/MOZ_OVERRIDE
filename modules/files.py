...
class SIXMOZ_files():
    ...
    def find_idl_files():
        ...
        if (SIXMOZ_options.idl_folder != ""):
            ...
            idl_files = string.split(commands.getstatusoutput("find " + SIXMOZ_options.idl_folder + " -type f -readable \( " +
    ...
    def find_files():
        ...
        files = string.split(commands.getstatusoutput("find " + SIXMOZ_options.path + " -type f -readable " +
                                                      SIXMOZ_rules.get_conf('extensions') + " -or -name \"*.cpp\" | sort")[1], "\n")
        return (files)
